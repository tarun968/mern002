...
import Fgpassword from './user/fgpassword'
...
export default function Routing() {
    ...
    <Route path="Forgotten-password" element={<Fgpassword/>}></Route>
    ...
    <Route path="admin/product/update/:productId" element={<UpdateProducts/>}></Route>
